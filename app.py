...
# base configurations for the app
st.set_page_config(page_title="JobAI", layout="wide")
st.title("JobAI - Your AI-Powered Job Search Companion")
st.markdown("Upload your resume and get personalized job recommendations, resume feedback, and interview preparation strategies based on your skills and experience.")
...
if uploaded_file:
    ...
    with st.spinner("Summarizing your resume and generating insights..."):
        summary=ask_openai(f"Summarize this resume and highlighting the skills,education and experience mentioned in it :\n\n{resume_text}",max_tokens=500)
...
# creating button
    ...
    if st.button("🔎Get Job Recommendations"):
        ...
        with st.spinner("Fetching jobs from LinkedIn and Naukri..."):
            linkedin_jobs = fetch_linkedin_jobs(search_keywords_clean, rows=70)
            naukri_jobs = fetch_naukri_jobs(search_keywords_clean, rows=70)
